...
ants_condition_org = [1, 1, 1]
ants_depot_org = [1, 1, 0]          # ant condition = 1
pathtime_remained_org = [0, 0, 0]   # ant condition = 2
ants_link_org = [-1, -1, -1]        # ant condition = 3
...
def utility():
    utility_u = [[0 for time in links] for links in tau]
    # utility function:
