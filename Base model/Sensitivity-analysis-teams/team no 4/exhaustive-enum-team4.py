...
for run_no in range(1000):    
    ...
    for iteration in range(iteration_number):
        ...
        ants_condition = [1, 1, 1, 1]
        ants_depot = [2, 2, 2, 2]          # ant condition = 1
        pathtime_remained = [0, 0, 0, 0]   # ant condition = 2
        ants_link = [-1, -1, -1, -1]        # ant condition = 3
...
textfile = open(f"{len(ants_condition)}in004.txt", "w")
